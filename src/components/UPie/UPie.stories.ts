    ...
    docs: {
      ...
      source: {
        transform: (src: string, storyContext: { args: ComponentArgs }) => {
          ...
          return `<u-pie${attrsString}></u-pie>`;
        },
      },
    },
    Vuetify: {
...
export const Default: StoryFn<ComponentArgs> = (args) => ({
  ...
  template: `<div class="d-flex justify-center"><u-pie v-bind="args"/></div>`,
});
...
/**
 * Charts are more like drawings then regular HTML elements and their size needs to be
...
Size.parameters = {
  docs: {
    source: {
      code: `
<template>${sizeTemplate}</template>
<script setup>
  const items = [
    { key: 1, title: 'Series A', value: 45, color: '#2b6d40' },
    { key: 2, title: 'Series B', value: 30, color: '#4e9963' },
...
Palette.parameters = {
  docs: {
    source: {
      code: `<template>${paletteTemplate}</template>
...
// Legend Position Story
const legendPositionTemplate = `
...
export const LegendPosition: StoryFn<ComponentArgs> = () => ({
  ...
  template: legendPositionTemplate,
});

LegendPosition.parameters = {
  docs: {
    source: {
      code: `<template>${legendPositionTemplate}</template>
...
// Item Text Overrides Story
const itemTextOverridesTemplate = `
...
export const ItemTextOverrides: StoryFn<ComponentArgs> = () => ({
  ...
  template: itemTextOverridesTemplate,
});

ItemTextOverrides.parameters = {
  docs: {
    source: {
      code: `<template>${itemTextOverridesTemplate}</template>
...
export const CustomLegend: StoryFn<ComponentArgs> = () => ({
  ...
  template: customLegendTemplate,
});

CustomLegend.parameters = {
  docs: {
    source: {
      code: `<template>${customLegendTemplate}</template>
...
// Overlay Patterns Story
const overlayPatternsTemplate = `
...
export const OverlayPatterns: StoryFn<ComponentArgs> = () => ({
  ...
  template: overlayPatternsTemplate,
});

OverlayPatterns.parameters = {
  docs: {
    source: {
      code: `<template>${overlayPatternsTemplate}</template>
