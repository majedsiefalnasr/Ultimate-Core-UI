 ...
 */
export const Image: StoryFn<ComponentArgs> = (args) => ({
  ...
  setup() {
    ...
    return { args, loaded, resetToPoster, posterUrl, randomizePoster, posterId };
  },
  template: `
    <div>
      <u-video
...
Image.parameters = {
  ...
  <div>
    ...
    <div class="d-flex justify-center ga-3">
      <u-btn text="randomize image" @click="randomizePoster"></u-btn>
      <u-btn text="restore original" @click="posterId = null"></u-btn>
      <u-btn
        :disabled="!loaded"
 ...
 */
export const StartAt: StoryFn<ComponentArgs> = (args) => ({
  components: { UVideo },
  setup() {
    return { args };
  },
...
export const Color: StoryFn<ComponentArgs> = (args) => ({
  ...
  setup() {
    ...
    return { args, features, controlsVariant, colors };
  },
  template: `
  <div>
...
/**
 * Border radius for the video and controls can be controlled separately if you pass an array to the rounded prop.
 */
export const Rounded: StoryFn<ComponentArgs> = (args) => ({
  components: { UVideo },
  setup() {
    return { args };
  },
 ...
 */
export const Header: StoryFn<ComponentArgs> = (args) => ({
 ...
 */
export const AppendPrepend: StoryFn<ComponentArgs> = (args) => ({
 ...
 */
export const Controls: StoryFn<ComponentArgs> = (args) => ({
 ...
 */
export const YouTubeClone: StoryFn<ComponentArgs> = (args) => ({
