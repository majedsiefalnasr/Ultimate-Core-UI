...
VModel.parameters = {
  docs: {
    source: {
      code: `
<template>${vModelTemplate}</template>
...
Persistent.parameters = {
  docs: {
    source: {
      code: `
<template>${persistentTemplate}</template>
<script setup lang="ts">
import { ref } from 'vue';
...
export const Nesting: StoryFn<ComponentArgs> = () => ({
  ...
  template: nestingTemplate,
});

Nesting.parameters = {
  docs: {
    source: {
      code: `<template>${nestingTemplate}</template>
...
export const Overflowed: StoryFn<ComponentArgs> = () => ({
  components: { UDialog, UBtn, UCard, UCardText, UCardActions, USpacer },
  setup() {
    return {};
  },
  template: overflowedTemplate,
});

Overflowed.parameters = {
  docs: {
    source: {
      code: `<template>${overflowedTemplate}</template>`,
    },
  },
};
...
Scrollable.parameters = {
  docs: {
    source: {
      code: `
<template>${scrollableTemplate}</template>
...
Loader.parameters = {
  docs: {
    source: {
      code: `
<template>${loaderTemplate}</template>
...
Fullscreen.parameters = {
  docs: {
    source: {
      code: `
<template>${fullscreenTemplate}</template>
...
export const InviteDialog: StoryFn<ComponentArgs> = () => ({
  ...
  template: inviteDialogTemplate,
});

InviteDialog.parameters = {
  docs: {
    source: {
      code: `<template>${inviteDialogTemplate}</template>`,
    },
  },
};
...
DataTable.parameters = {
  docs: {
    source: {
      code: `
<template>${dataTableTemplate}</template>
