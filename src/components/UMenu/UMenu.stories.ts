...
export const OpenOnHover: StoryFn<ComponentArgs> = () => ({
  ...
  template: openOnHoverTemplate,
});

OpenOnHover.parameters = {
  docs: {
    source: {
      code: `<template>${openOnHoverTemplate}</template>
...
export const NestedMenus: StoryFn<ComponentArgs> = () => ({
  ...
  template: nestedMenusTemplate,
});

NestedMenus.parameters = {
  docs: {
    source: {
      code: `<template>${nestedMenusTemplate}</template>`,
    },
  },
};

// Positioning With Coordinates story
const positioningWithCoordinatesTemplate = `
...
export const PositioningWithCoordinates: StoryFn<ComponentArgs> = () => ({
  ...
  template: positioningWithCoordinatesTemplate,
});

PositioningWithCoordinates.parameters = {
  docs: {
    source: {
      code: `<template>${positioningWithCoordinatesTemplate}</template>
...
// Activator And Tooltip story
const activatorAndTooltipTemplate = `
    <div class="text-center">
      <u-menu>
...
export const ActivatorAndTooltip: StoryFn<ComponentArgs> = () => ({
  ...
  template: activatorAndTooltipTemplate,
});

ActivatorAndTooltip.parameters = {
  docs: {
    source: {
      code: `<template>${activatorAndTooltipTemplate}</template>
...
export const Transitions: StoryFn<ComponentArgs> = () => ({
  ...
  template: transitionsTemplate,
});

Transitions.parameters = {
  docs: {
    source: {
      code: `<template>${transitionsTemplate}</template>
...
PopoverMenu.parameters = {
  docs: {
    source: {
      code: `<template>${popoverMenuTemplate}</template>
...
// Use In Components story
const useInComponentsTemplate = `
    <u-row>
      <u-col
        cols="12"
        offset-sm="3"
...
export const UseInComponents: StoryFn<ComponentArgs> = () => ({
  ...
  template: useInComponentsTemplate,
});

UseInComponents.parameters = {
  docs: {
    source: {
      code: `<template>${useInComponentsTemplate}</template>
