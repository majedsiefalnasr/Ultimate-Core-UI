...
const meta: Meta<ComponentArgs> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'The u-data-iterator component is used for displaying arbitrary data, and shares a majority of its functionality with the v-data-table component. Features include sorting, searching, pagination, and selection.',
      },
  ...
  <template #footer="{ pageCount }">
    ...
    Vuetify: {
      ...
      content:
        'The u-data-iterator allows you to customize exactly how to display your data. In this example we are using a grid with cards.',
    ...
    anatomy: {
      title: 'Anatomy',
      description: 'The recommended placement of elements inside of a u-data-iterator are:',
...
/**
 * The u-data-iterator has internal state for both selection and expansion, just like u-data-table. In this example we use the methods isExpanded and toggleExpand available on the default slot.
 */
...
DefaultSlot.parameters = {
  docs: {
    source: {
      code: `
<template>${defaultSlotTemplate}</template>
...
const desserts = [
  ...
  { name: 'Cupcake', icon: 'hugeicons:cupcake-01', color: '#FFADAD', description: '...', calories: 305, fat: 3.7, carbs: 67, protein: 4.3, sodium: 413, calcium: '3%', iron: '8%' },
];
</script>`,
    },
  },
...
/**
 * The u-data-iterator has both a header and footer slot for adding extra content.
 */
export const HeaderAndFooter: StoryFn<ComponentArgs> = () => ({
  ...
  template: headerAndFooterTemplate,
});
...
HeaderAndFooter.parameters = {
  docs: {
    source: {
      code: `
<template>${headerAndFooterTemplate}</template>
<script setup lang="ts">
...
// Controllable Props story
const controllablePropsTemplate = `
    <u-card>
...
export const ControllableProps: StoryFn<ComponentArgs> = () => ({
  ...
  template: controllablePropsTemplate,
});
...
ControllableProps.parameters = {
  docs: {
    source: {
      code: `
<template>${controllablePropsTemplate}</template>
<script setup lang="ts">
import { shallowRef } from 'vue';
const search = shallowRef('');
const games = [
  ...
  { img: 'https://cdn.vuetifyjs.com/docs/images/graphics/games/5.png', title: 'Neon-Lit High-Speed Racing Thrills', subtitle: '...', duration: '12 minutes' },
];
</script>`,
    },
  },
...
LoaderProps.parameters = {
  docs: {
    source: {
      code: `
<template>${loaderPropsTemplate}</template>
<script setup lang="ts">
import { shallowRef } from 'vue';
const itemsPerPage = shallowRef(4);
const mice = [
